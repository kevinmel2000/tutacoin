    ...
    <div class="mbr-section__container container mbr-section__container--isolated">
        <div class="mbr-header mbr-header--wysiwyg row">
            <div class="col-sm-8 col-sm-offset-2">
                <h3 class="mbr-header__text">JUAL BITCOIN</h3>
            </div>
        </div>
    </div>
</section>
...
<section class="mbr-section" id="header3-18">
    <div class="mbr-section__container container mbr-section__container--first">
        <div class="mbr-header mbr-header--wysiwyg row">
            <div class="col-sm-8 col-sm-offset-2">
                <h3 class="mbr-header__text">JUAL 1 BTC = Rp. {{number_format($bitcoin_rate_jual, 2,'.', ',')}}</h3>
                <p class="mbr-header__subtext">Untuk Melakukan Penjualan Bitcoin, silahkan lengkapi isian dibawah.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="mbr-article mbr-article--wysiwyg col-sm-8 col-sm-offset-2">
              ...
              <div class="panel panel-default">
                <div class="panel-body">
                  ...
                  <table class="table">
                      <tr><td>NO. TRANSAKSI</td><td>:</td><td>J{{ Session::get('no_transaksi') }}</td></tr>
                      ...
                      <tr><td>JUAL BTC</td><td>:</td><td>{{ Session::get('btc_jual') }}</td></tr>
                      <tr><td>RUPIAH</td><td>:</td><td>Rp. {{ number_format(Session::get('rupiah_jual'), 0, ',', '.') }}</td></tr>
                  </table>
                  <hr />
                  KETERANGAN:
                </div>
              ...
              <div class="panel panel-default">
                <div class="panel-body">
                  ...
                  <div class="row" ng-controller="MainCtrl">
                      ...
                      <div class="form-group">
                      {!! Form::label('btc_jual', 'BTC') !!}
                      <input type="text" class="form-control" required="required" name="btc_jual" ng-init="jual_bitcoin='0'" ng-model="jual_bitcoin" valid-number />
                    ...
                    <div class="col-md-6">
                      ...
                      <p class="form-control-static">Rp. {{jual_bitcoin * <?php echo $bitcoin_rate_jual;?> | number:2}}</p>
                      </div>
                    </div>
                    <div align="right" class="col-md-12">
                      {!! Form::submit('Jual', array('class' => 'btn btn-primary')) !!}
                    </div>
